      ...
      <div className="carouselContainer">
        <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-inner">
                ...
                <img src="https://ca.slack-edge.com/T0351JZQ0-U02QR4J2XQW-abce7c044f36-512" className="d-block w-100" alt="Adel-Hasan-Photo"/>
                <div className="carousel-caption d-none d-md-block">
                    <a href="#">Adel Hasan</a>
                ...
                <div className="carousel-item">
                <img src="https://th.bing.com/th/id/R.9641c4956c05b474164e84e85c7be589?rik=78I%2bO6PphQoOtA&pid=ImgRaw&r=0" className="d-block w-100" alt="Jason Hensleys Photo"/>
                <div className="carousel-caption d-none d-md-block">
